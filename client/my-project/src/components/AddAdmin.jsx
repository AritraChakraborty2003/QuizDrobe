    ...
    <>
      <body className="bg-backQuiz">
        ...
        {(localStorage.getItem("loggedinadmin") === "true" && (
          <div className="pb-10  main w-[100vw] flex justify-center items-center">
            <div className="flex flex-col justify-center items-center mt-1">
              ...
              >
                ...
                <div className="bg-background flex space-x-2 w-[80vw] md:w-[87vmin] border-bodytext border-b-2">
                  <input
