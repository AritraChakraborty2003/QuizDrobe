  ...
  return (
    <>
      ...
      <div className="block lg:hidden">
        <div className=" pb-10 bg-gradient-to-bl from-background to-backQuiz  lg:bg-gradient-to-tl lg:from-background lg:to-background  main  h-[100vh] w-[100vw] flex justify-center items-center">
